...
document.getElementById("s_province").onchange = function() {				
				document.getElementById("s_city")[1].selected = true;
			}
document.getElementById("s_city").onchange = function() {				
				document.getElementById("s_county")[1].selected = true;
			}
