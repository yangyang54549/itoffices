<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"E:\GitHub\itoffice\public/../application/admin\view\one\two\three\four\index.html";i:1488899632;s:70:"E:\GitHub\itoffice\public/../application/admin\view\template\base.html";i:1488899632;s:81:"E:\GitHub\itoffice\public/../application/admin\view\template\javascript_vars.html";i:1488899632;s:80:"E:\GitHub\itoffice\public/../application/admin\view\one\two\three\four\form.html";i:1488899632;s:78:"E:\GitHub\itoffice\public/../application/admin\view\one\two\three\four\th.html";i:1488899632;s:78:"E:\GitHub\itoffice\public/../application/admin\view\one\two\three\four\td.html";i:1488899632;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="字段一" name="field1" value="<?php echo \think\Request::instance()->param('field1'); ?>" >
...
<td><?php echo high_light($vo['field1'],\think\Request::instance()->param('field1')); ?></td>
<td><?php echo $vo['option']; ?></td>
<td><?php echo $vo['select']; ?></td>
<td><?php echo $vo['radio']; ?></td>
<td><?php echo $vo['checkbox']; ?></td>
<td><?php echo $vo['password']; ?></td>
<td><?php echo $vo['textarea']; ?></td>
...
<script>
    $(function () {
        $("[name='select']").find("[value='<?php echo \think\Request::instance()->param('select'); ?>']").attr("selected", true);
    })
</script>
