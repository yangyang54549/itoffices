...
<td><?php echo $vo['name']; ?></td>
            <td class="f-14">
                ...
                <a href="javascript:;" onclick="del_forever(this,'<?php echo $vo['id']; ?>','/admin/specific/deleteforever.html')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i></a>
            </td>
        </tr>
