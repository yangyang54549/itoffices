<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\GitHub\itoffice\public/../application/index\view\cases\computer.html";i:1517393514;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .center .left {
                background-image: url(__INDEX__/img/display.png);
...
<!--                         <div class="" id="column_1">
        ...
        <div class="phone">
            <iframe src="<?php echo url('cases/computers',['id'=>$cases['id']]); ?>" width="" height=""></iframe>
        </div>
        <div class="forms">
            <form action="" method="post">
                <ul>
                    ...
                    <li class="item-li" style="margin-top: 80px">
        ...
        <script type="text/javascript">
            ...
            $(".btn").click(function() {
                ...
                var id = <?php echo $cases['id']; ?>;
                var name = xname.value;
                var remark = brief.value;
                var username = names.value;
                var wxchat = weixin.value;
                var phone = ph.value;
                            ...
                            if(weixin.value == "") {
                                ...
                                if(ph.value == "") {
                                    ...
                                    if(mail.value == "") {
                                        ...
                                        alert(phone);
                                        $.post(
                                            "<?php echo url('cases/order'); ?>",
                                            {id:id,name:name,remark:remark,username:username,wxchat:wxchat,phone:phone,email:email},
                                            function(data) {
                                                alert(data.msg)
                                            })
                                    }
